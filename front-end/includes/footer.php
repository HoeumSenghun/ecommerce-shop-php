    ...
    <footer class="bg-light py-4 mt-auto">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="terms.php" class="text-decoration-none">Terms of Service</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5>Contact Info</h5>
                    <ul class="list-unstyled">
                        <li>Email: contact@jojoba.com</li>
            ...
            <div class="text-center">
                <p class="mb-0">&copy; <?= date('Y') ?> JoJoBa Shop. All rights reserved.</p>
            </div>
        </div>
    </footer>
